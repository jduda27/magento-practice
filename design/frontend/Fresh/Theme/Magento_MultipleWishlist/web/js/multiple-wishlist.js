...
define([
    ...
    $.widget('mage.multipleWishlist', {
        options: {
            ...
            createTmplData: {
                ...
                isEdit: false,
                translate: {
                    createNewWishlist: $t('Create New Portfolio'),
                    editWishlist: $t('Edit Portfolio'),
                    wishListName: $t('Portfolio Name'),
                    // publicWishList: $t('Public Portfolio'),
                    close: $t('Close'),
                    save: $t('Save'),
                    cancel: $t('Cancel')
                }
            },
            errorMsg: $.mage.__('We can\'t create the Portfolio right now.'),
    ...
    // Extension for mage.wishlist - Move to Portfolio
    $.widget('mage.multipleWishlist', $.mage.multipleWishlist, {
         ...
         * @private
         * @param {jQuery.Event} e - "Move to Portfolio" button
         */
        ...
        _itemsSelected: function () {
           return $(this.options.wishlistFormSelector).find('input[type=checkbox]:checked').length ? true : false;
        }
    });
    ...
    $.widget('mage.multipleWishlist', $.mage.multipleWishlist, {
        options: {
            deleteMsg: $.mage.__('Are you sure you want to delete your portfolio? This action can\'t be undone.')
        },
         ...
         * @private
         * @param {jQuery.Event} e - "Delete Portfolio" button
         */
    ...
    $.widget('mage.promptEditWithList', $.mage.prompt, {
        ...
        getNoticeTemplate: function () {
            var template = $('<div class="field choice" style ="display:none;">' +
    ...
    $.widget('mage.multipleWishlist', $.mage.multipleWishlist, {
        ...
        _createEditWishlistModal: function (e)  {
            ...
            $.mage.promptEditWithList({
                ...
                label: $.mage.__('Portfolio Name'),
                isPublicFieldLabel: $.mage.__('Public Portfolio'),
    ...
    $.widget('mage.multipleWishlist', $.mage.multipleWishlist, {
        ...
        /**
         * Build "Add to Portfolio" dropdown list
         * @private
         */
            ...
            if (this.options.wishlists && this.options.wishlists.length > 0) {
                $(this.options.wishlistLink).each($.proxy(function (index, e) {
                    ...
                    if (this.options.canCreate) {
                        tmplData.wishlists.push({
                            newClass: 'new',
                            name: $.mage.__('Create New Portfolio'),
